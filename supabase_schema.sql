-- ====================================================
-- MODERN LIFE RESIDENCE - SCRIPT SQL COMPLETO SUPABASE (INFALÍVEL)
-- Cole e execute todo este conteúdo no SQL Editor do Supabase
-- ====================================================
...
-- REMOVER POLÍTICAS ANTIGAS COM SEGURANÇA
...
-- CRIAR NOVAS POLÍTICAS GRANULARES DE SEGURANÇA
...
-- REVOGAR TRUNCATE DA ROLE PÚBLICA ANON
REVOKE TRUNCATE, TRIGGER ON ALL TABLES IN SCHEMA public FROM anon;

-- CONCEDER ACESSO DE LEITURA E ESCRITA
